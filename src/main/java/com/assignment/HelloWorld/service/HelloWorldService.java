    ...
    private String GetByLangAPI(String lang) {
        ...
        try {
            HttpRequest request = HttpRequest.newBuilder()
                    .uri(URI.create("https://microsoft-translator-text.p.rapidapi.com/translate?to%5B0%5D=" + lang + "&api-version=3.0&from=en&profanityAction=NoAction&textType=plain"))
